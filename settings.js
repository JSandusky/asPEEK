var settings =
{
  ...
  "reconnectdelay": 250, // time between each attempt connect to server

  "tabsize": 4, // editor tab size. soft-tabs.
  "theme": "zenburn", // editor theme. look at js/ace/ folder see the available themes. chrome and xcode are good light editors. my interpretation of the famous zenburn is the default, i hope you like it
